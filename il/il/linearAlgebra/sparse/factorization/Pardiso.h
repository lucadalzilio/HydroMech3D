...
template <typename Int>
inline void PardisoSizeIntSelector<Int>::pardiso_int_t(
...
template <>
inline void PardisoSizeIntSelector<std::ptrdiff_t>::pardiso_int_t(
...
inline void Pardiso::SymbolicFactorization(
    const il::SparseMatrixCSR<il::int_t, double> &A) {
...
inline void Pardiso::NumericalFactorization(
    const il::SparseMatrixCSR<il::int_t, double> &A) {
